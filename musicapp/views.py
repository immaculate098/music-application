...
#     return render(request, 'musicapp/dashboard.html', {'filter': search_filter, 'results': results})
...
#         default_search_results = sp.search(q='track:love', type='track', limit=10)
#         for track in default_search_results['tracks']['items']:
#             results.append({
#                 'name': track['name'],
#                 'artist_name': track['artists'][0]['name'],
#                 'album_name': track['album']['name'],
...
def artist_profile_view(request, artist_id):
    ...
    return render(request, 'musicapp/artist_profile.html', context)
...
def artists_view(request):
    ...
    return render(request, 'musicapp/artists.html', {'artists_data': artists_data})
...
def track_detail_view(request, track_id):
    ...
    return render(request, 'musicapp/track_detail.html', context)
def add_to_playlist(request, track_id):
    if request.method == 'POST':
        ...
        return render(request, 'musicapp/add_to_playlist_result.html', {'message': message})
    else:
...
# music/views.py
from django.shortcuts import render
# Ensure the following import path is correct and uncomment it:
# from .spotify_utils import get_trending_tracks
...
def trending_music(request):
    ...
    return render(request, 'musicapp/trending_music.html', {'tracks': filtered_tracks})
# views.py
...
def video_list(request):
    ...
    return render(request, 'musicapp/video_list.html', context)
from django.shortcuts import render
